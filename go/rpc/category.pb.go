...
type Category struct {
	...
	UrlImage string     `protobuf:"bytes,3,opt,name=url_image,json=urlImage,proto3" json:"url_image,omitempty"`
...
func (x *Category) GetUrlImage() string {
	if x != nil {
		return x.UrlImage
	}
	return ""
...
func (x *Category) GetTime() *Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
var file_category_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x70, 0x69, 0x7a, 0x7a, 0x62, 0x69, 0x72, 0x64, 0x1a, 0x0f, 0x74, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7a, 0x0a, 0x08, 0x43,
	...
	0x64, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x72, 0x6c, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x72, 0x6c, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x27,
...
var file_category_proto_goTypes = []interface{}{
	(*Category)(nil),  // 0: pizzbird.Category
	(*Timestamp)(nil), // 1: pizzbird.Timestamp
}
var file_category_proto_depIdxs = []int32{
	1, // 0: pizzbird.Category.time:type_name -> pizzbird.Timestamp
